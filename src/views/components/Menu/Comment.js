...
function Comment({ value }) {
    ...
    return (
        <div className='flex gap-x-8 py-4 md:py-8 w-2/3 border-2 border-gray-500 rounded-3xl hover:border-indigo-400 hover:bg-indigo-100 transition-colors duration-300'>
