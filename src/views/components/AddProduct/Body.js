...
function Body() {
    const [image, setImage] = useState('https://static.cdn.packhelp.com/wp-content/uploads/2019/06/06153013/plain-shipping-boxes-packhelp-kva.jpg');
    ...
    function handlePostProduct() {
        if (product.name == '') {
            ...
            alert('Please enter price product !');
    ...
    return (
        <div className="flex flex-col flex-grow font-poppins min-h-screen">
            <div className="flex items-center flex-shrink-0 sm:h-16 h-12 px-8 border-b border-gray-300">
                <h1 className=" uppercase sm:text-xl text-base font-medium">Create product</h1>
            </div>
                ...
                <div className='form'>
                    ...
                    <div className='md:flex md:flex-row md:space-x-4 w-full text-xs'>
                        ...
                        <div className='w-full flex flex-col mb-3'>
                            ...
                            <select onChange={handleType} className='block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 md:w-full '>
